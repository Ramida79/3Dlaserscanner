...
import java.io.File;
import com.ramida.a3dlaserscaner.STLRenderer;
import com.ramida.a3dlaserscaner.Log;
import  com.ramida.a3dlaserscaner.STLView;
...
/**
 * Created by Ramida on 2017-01-22.
 */
    ...
    private void setUpViews(Uri uri) {
        ...
        loadButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences config = getSharedPreferences("PathSetting", Activity.MODE_PRIVATE);
                fileListDialog.show(config.getString("lastPath", "/sdcard/3DScannerData/"));
            }
        });
